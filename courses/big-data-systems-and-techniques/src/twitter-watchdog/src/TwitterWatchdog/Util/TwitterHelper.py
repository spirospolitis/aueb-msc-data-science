...
class TwitterHelper(TwitterBase.TwitterBase):
    ...
    """
    # async def get_trends(self, queue: asyncio.Queue, woe_id: str):
    #     self.__queue = queue
    #
    #     if globals.__DEBUG__:
    #         logging.debug("TwitterHelper:get_trends():queue:{}:woe_id:{}".format(queue, woe_id))
    #
    ...
    #
    #     await self.__queue.put(trends)
    #
    #     await asyncio.sleep(0)
    #
    #     # asyncio.ensure_future(callback(super().api.trends_place(id=woe_id)))
