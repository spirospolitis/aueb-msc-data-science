...
for i, line in enumerate(sys.stdin):
    ...
    word_combinations = itertools.combinations(words, 3)

    for word_combination in word_combinations:
        # Produce a key with format
        # <tupple 1st word>-<tupple 2nd word>-<tupple 3rd word>
        # Tab (\t) demarkates key, value
        print("({},{},{})\t{}".format(word_combination[0], word_combination[1], word_combination[2], "1"))